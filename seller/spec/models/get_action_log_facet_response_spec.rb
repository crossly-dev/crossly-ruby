...
# Unit tests for Crossly::GetActionLogFacetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetActionLogFacetResponse do
  let(:instance) { Crossly::GetActionLogFacetResponse.new }

  describe 'test an instance of GetActionLogFacetResponse' do
    it 'should create an instance of GetActionLogFacetResponse' do
      expect(instance).to be_instance_of(Crossly::GetActionLogFacetResponse)
    end
  end
