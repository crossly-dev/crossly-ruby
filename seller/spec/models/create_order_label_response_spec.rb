...
# Unit tests for Crossly::CreateOrderLabelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateOrderLabelResponse do
  let(:instance) { Crossly::CreateOrderLabelResponse.new }

  describe 'test an instance of CreateOrderLabelResponse' do
    it 'should create an instance of CreateOrderLabelResponse' do
      expect(instance).to be_instance_of(Crossly::CreateOrderLabelResponse)
    end
  end
