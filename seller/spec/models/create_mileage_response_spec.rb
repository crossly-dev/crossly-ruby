...
# Unit tests for Crossly::CreateMileageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateMileageResponse do
  let(:instance) { Crossly::CreateMileageResponse.new }

  describe 'test an instance of CreateMileageResponse' do
    it 'should create an instance of CreateMileageResponse' do
      expect(instance).to be_instance_of(Crossly::CreateMileageResponse)
    end
  end
