...
# Unit tests for Crossly::DeleteSavedViewResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteSavedViewResponse do
  let(:instance) { Crossly::DeleteSavedViewResponse.new }

  describe 'test an instance of DeleteSavedViewResponse' do
    it 'should create an instance of DeleteSavedViewResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteSavedViewResponse)
    end
  end
