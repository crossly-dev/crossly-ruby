...
# Unit tests for Crossly::ListPolicyPresetsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListPolicyPresetsItem do
  let(:instance) { Crossly::ListPolicyPresetsItem.new }

  describe 'test an instance of ListPolicyPresetsItem' do
    it 'should create an instance of ListPolicyPresetsItem' do
      expect(instance).to be_instance_of(Crossly::ListPolicyPresetsItem)
    end
  end
