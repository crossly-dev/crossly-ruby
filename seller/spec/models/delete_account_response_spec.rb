...
# Unit tests for Crossly::DeleteAccountResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteAccountResponse do
  let(:instance) { Crossly::DeleteAccountResponse.new }

  describe 'test an instance of DeleteAccountResponse' do
    it 'should create an instance of DeleteAccountResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteAccountResponse)
    end
  end
