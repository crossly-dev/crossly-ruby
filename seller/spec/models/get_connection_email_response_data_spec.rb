...
# Unit tests for Crossly::GetConnectionEmailResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetConnectionEmailResponseData do
  let(:instance) { Crossly::GetConnectionEmailResponseData.new }
  ...
  describe 'test an instance of GetConnectionEmailResponseData' do
    it 'should create an instance of GetConnectionEmailResponseData' do
      expect(instance).to be_instance_of(Crossly::GetConnectionEmailResponseData)
    end
  end
