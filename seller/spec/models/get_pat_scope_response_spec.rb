...
# Unit tests for Crossly::GetPatScopeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetPatScopeResponse do
  let(:instance) { Crossly::GetPatScopeResponse.new }

  describe 'test an instance of GetPatScopeResponse' do
    it 'should create an instance of GetPatScopeResponse' do
      expect(instance).to be_instance_of(Crossly::GetPatScopeResponse)
    end
  end
