...
# Unit tests for Crossly::GetCbxSubjectWalletResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetCbxSubjectWalletResponse do
  let(:instance) { Crossly::GetCbxSubjectWalletResponse.new }
  ...
  describe 'test an instance of GetCbxSubjectWalletResponse' do
    it 'should create an instance of GetCbxSubjectWalletResponse' do
      expect(instance).to be_instance_of(Crossly::GetCbxSubjectWalletResponse)
    end
  end
