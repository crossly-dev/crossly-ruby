...
# Unit tests for Crossly::ListBuyerScanSessionsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListBuyerScanSessionsItem do
  let(:instance) { Crossly::ListBuyerScanSessionsItem.new }

  describe 'test an instance of ListBuyerScanSessionsItem' do
    it 'should create an instance of ListBuyerScanSessionsItem' do
      expect(instance).to be_instance_of(Crossly::ListBuyerScanSessionsItem)
    end
  end
