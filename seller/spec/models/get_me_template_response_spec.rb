...
# Unit tests for Crossly::GetMeTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetMeTemplateResponse do
  let(:instance) { Crossly::GetMeTemplateResponse.new }

  describe 'test an instance of GetMeTemplateResponse' do
    it 'should create an instance of GetMeTemplateResponse' do
      expect(instance).to be_instance_of(Crossly::GetMeTemplateResponse)
    end
  end
