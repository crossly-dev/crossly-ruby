...
# Unit tests for Crossly::ListMeTemplatesItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListMeTemplatesItem do
  let(:instance) { Crossly::ListMeTemplatesItem.new }

  describe 'test an instance of ListMeTemplatesItem' do
    it 'should create an instance of ListMeTemplatesItem' do
      expect(instance).to be_instance_of(Crossly::ListMeTemplatesItem)
    end
  end
