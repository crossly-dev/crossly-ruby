...
# Unit tests for Crossly::UpdateTeamResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::UpdateTeamResponse do
  let(:instance) { Crossly::UpdateTeamResponse.new }

  describe 'test an instance of UpdateTeamResponse' do
    it 'should create an instance of UpdateTeamResponse' do
      expect(instance).to be_instance_of(Crossly::UpdateTeamResponse)
    end
  end
