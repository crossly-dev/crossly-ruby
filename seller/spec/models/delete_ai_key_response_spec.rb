...
# Unit tests for Crossly::DeleteAiKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteAiKeyResponse do
  let(:instance) { Crossly::DeleteAiKeyResponse.new }

  describe 'test an instance of DeleteAiKeyResponse' do
    it 'should create an instance of DeleteAiKeyResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteAiKeyResponse)
    end
  end
