...
# Unit tests for Crossly::DeletePatResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeletePatResponse do
  let(:instance) { Crossly::DeletePatResponse.new }

  describe 'test an instance of DeletePatResponse' do
    it 'should create an instance of DeletePatResponse' do
      expect(instance).to be_instance_of(Crossly::DeletePatResponse)
    end
  end
