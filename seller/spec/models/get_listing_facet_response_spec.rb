...
# Unit tests for Crossly::GetListingFacetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetListingFacetResponse do
  let(:instance) { Crossly::GetListingFacetResponse.new }

  describe 'test an instance of GetListingFacetResponse' do
    it 'should create an instance of GetListingFacetResponse' do
      expect(instance).to be_instance_of(Crossly::GetListingFacetResponse)
    end
  end
