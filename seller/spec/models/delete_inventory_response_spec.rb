...
# Unit tests for Crossly::DeleteInventoryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteInventoryResponse do
  let(:instance) { Crossly::DeleteInventoryResponse.new }

  describe 'test an instance of DeleteInventoryResponse' do
    it 'should create an instance of DeleteInventoryResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteInventoryResponse)
    end
  end
