...
# Unit tests for Crossly::ListInventoryUnitsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListInventoryUnitsItem do
  let(:instance) { Crossly::ListInventoryUnitsItem.new }

  describe 'test an instance of ListInventoryUnitsItem' do
    it 'should create an instance of ListInventoryUnitsItem' do
      expect(instance).to be_instance_of(Crossly::ListInventoryUnitsItem)
    end
  end
