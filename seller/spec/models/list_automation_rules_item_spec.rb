...
# Unit tests for Crossly::ListAutomationRulesItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListAutomationRulesItem do
  let(:instance) { Crossly::ListAutomationRulesItem.new }

  describe 'test an instance of ListAutomationRulesItem' do
    it 'should create an instance of ListAutomationRulesItem' do
      expect(instance).to be_instance_of(Crossly::ListAutomationRulesItem)
    end
  end
