...
# Unit tests for Crossly::ListAutomationRunsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListAutomationRunsItem do
  let(:instance) { Crossly::ListAutomationRunsItem.new }

  describe 'test an instance of ListAutomationRunsItem' do
    it 'should create an instance of ListAutomationRunsItem' do
      expect(instance).to be_instance_of(Crossly::ListAutomationRunsItem)
    end
  end
