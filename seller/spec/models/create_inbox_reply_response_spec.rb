...
# Unit tests for Crossly::CreateInboxReplyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateInboxReplyResponse do
  let(:instance) { Crossly::CreateInboxReplyResponse.new }

  describe 'test an instance of CreateInboxReplyResponse' do
    it 'should create an instance of CreateInboxReplyResponse' do
      expect(instance).to be_instance_of(Crossly::CreateInboxReplyResponse)
    end
  end
