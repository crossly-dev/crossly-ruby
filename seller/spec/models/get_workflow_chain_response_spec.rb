...
# Unit tests for Crossly::GetWorkflowChainResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetWorkflowChainResponse do
  let(:instance) { Crossly::GetWorkflowChainResponse.new }

  describe 'test an instance of GetWorkflowChainResponse' do
    it 'should create an instance of GetWorkflowChainResponse' do
      expect(instance).to be_instance_of(Crossly::GetWorkflowChainResponse)
    end
  end
