...
# Unit tests for Crossly::ListInventoryItemCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListInventoryItemCategory do
  let(:instance) { Crossly::ListInventoryItemCategory.new }

  describe 'test an instance of ListInventoryItemCategory' do
    it 'should create an instance of ListInventoryItemCategory' do
      expect(instance).to be_instance_of(Crossly::ListInventoryItemCategory)
    end
  end
