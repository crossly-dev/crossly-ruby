...
# Unit tests for Crossly::ListMobilePushTokensItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListMobilePushTokensItem do
  let(:instance) { Crossly::ListMobilePushTokensItem.new }

  describe 'test an instance of ListMobilePushTokensItem' do
    it 'should create an instance of ListMobilePushTokensItem' do
      expect(instance).to be_instance_of(Crossly::ListMobilePushTokensItem)
    end
  end
