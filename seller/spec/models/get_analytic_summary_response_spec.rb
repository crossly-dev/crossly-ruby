...
# Unit tests for Crossly::GetAnalyticSummaryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAnalyticSummaryResponse do
  let(:instance) { Crossly::GetAnalyticSummaryResponse.new }

  describe 'test an instance of GetAnalyticSummaryResponse' do
    it 'should create an instance of GetAnalyticSummaryResponse' do
      expect(instance).to be_instance_of(Crossly::GetAnalyticSummaryResponse)
    end
  end
