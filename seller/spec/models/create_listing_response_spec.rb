...
# Unit tests for Crossly::CreateListingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateListingResponse do
  let(:instance) { Crossly::CreateListingResponse.new }

  describe 'test an instance of CreateListingResponse' do
    it 'should create an instance of CreateListingResponse' do
      expect(instance).to be_instance_of(Crossly::CreateListingResponse)
    end
  end
