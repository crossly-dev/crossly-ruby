...
# Unit tests for Crossly::UpdateSavedViewResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::UpdateSavedViewResponse do
  let(:instance) { Crossly::UpdateSavedViewResponse.new }

  describe 'test an instance of UpdateSavedViewResponse' do
    it 'should create an instance of UpdateSavedViewResponse' do
      expect(instance).to be_instance_of(Crossly::UpdateSavedViewResponse)
    end
  end
