...
# Unit tests for Crossly::UpdateListingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::UpdateListingResponse do
  let(:instance) { Crossly::UpdateListingResponse.new }

  describe 'test an instance of UpdateListingResponse' do
    it 'should create an instance of UpdateListingResponse' do
      expect(instance).to be_instance_of(Crossly::UpdateListingResponse)
    end
  end
