...
# Unit tests for Crossly::ListPatItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListPatItem do
  let(:instance) { Crossly::ListPatItem.new }

  describe 'test an instance of ListPatItem' do
    it 'should create an instance of ListPatItem' do
      expect(instance).to be_instance_of(Crossly::ListPatItem)
    end
  end
