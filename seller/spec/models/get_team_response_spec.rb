...
# Unit tests for Crossly::GetTeamResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetTeamResponse do
  let(:instance) { Crossly::GetTeamResponse.new }

  describe 'test an instance of GetTeamResponse' do
    it 'should create an instance of GetTeamResponse' do
      expect(instance).to be_instance_of(Crossly::GetTeamResponse)
    end
  end
