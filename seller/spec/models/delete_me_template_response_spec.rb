...
# Unit tests for Crossly::DeleteMeTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteMeTemplateResponse do
  let(:instance) { Crossly::DeleteMeTemplateResponse.new }

  describe 'test an instance of DeleteMeTemplateResponse' do
    it 'should create an instance of DeleteMeTemplateResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteMeTemplateResponse)
    end
  end
