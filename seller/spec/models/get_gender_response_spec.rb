...
# Unit tests for Crossly::GetGenderResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetGenderResponse do
  let(:instance) { Crossly::GetGenderResponse.new }

  describe 'test an instance of GetGenderResponse' do
    it 'should create an instance of GetGenderResponse' do
      expect(instance).to be_instance_of(Crossly::GetGenderResponse)
    end
  end
