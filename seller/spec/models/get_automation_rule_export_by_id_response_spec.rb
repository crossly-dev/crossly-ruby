...
# Unit tests for Crossly::GetAutomationRuleExportByIdResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAutomationRuleExportByIdResponse do
  let(:instance) { Crossly::GetAutomationRuleExportByIdResponse.new }
  ...
  describe 'test an instance of GetAutomationRuleExportByIdResponse' do
    it 'should create an instance of GetAutomationRuleExportByIdResponse' do
      expect(instance).to be_instance_of(Crossly::GetAutomationRuleExportByIdResponse)
    end
  end
