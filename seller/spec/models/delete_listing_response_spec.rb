...
# Unit tests for Crossly::DeleteListingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteListingResponse do
  let(:instance) { Crossly::DeleteListingResponse.new }

  describe 'test an instance of DeleteListingResponse' do
    it 'should create an instance of DeleteListingResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteListingResponse)
    end
  end
