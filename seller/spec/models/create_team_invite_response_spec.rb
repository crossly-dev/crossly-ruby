...
# Unit tests for Crossly::CreateTeamInviteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateTeamInviteResponse do
  let(:instance) { Crossly::CreateTeamInviteResponse.new }

  describe 'test an instance of CreateTeamInviteResponse' do
    it 'should create an instance of CreateTeamInviteResponse' do
      expect(instance).to be_instance_of(Crossly::CreateTeamInviteResponse)
    end
  end
