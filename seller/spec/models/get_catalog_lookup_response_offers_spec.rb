...
# Unit tests for Crossly::GetCatalogLookupResponseOffers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetCatalogLookupResponseOffers do
  let(:instance) { Crossly::GetCatalogLookupResponseOffers.new }
  ...
  describe 'test an instance of GetCatalogLookupResponseOffers' do
    it 'should create an instance of GetCatalogLookupResponseOffers' do
      expect(instance).to be_instance_of(Crossly::GetCatalogLookupResponseOffers)
    end
  end
