...
# Unit tests for Crossly::CreateImportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateImportResponse do
  let(:instance) { Crossly::CreateImportResponse.new }

  describe 'test an instance of CreateImportResponse' do
    it 'should create an instance of CreateImportResponse' do
      expect(instance).to be_instance_of(Crossly::CreateImportResponse)
    end
  end
