...
# Unit tests for Crossly::GetAnalyticByPlatformResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAnalyticByPlatformResponse do
  let(:instance) { Crossly::GetAnalyticByPlatformResponse.new }
  ...
  describe 'test an instance of GetAnalyticByPlatformResponse' do
    it 'should create an instance of GetAnalyticByPlatformResponse' do
      expect(instance).to be_instance_of(Crossly::GetAnalyticByPlatformResponse)
    end
  end
