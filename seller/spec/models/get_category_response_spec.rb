...
# Unit tests for Crossly::GetCategoryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetCategoryResponse do
  let(:instance) { Crossly::GetCategoryResponse.new }

  describe 'test an instance of GetCategoryResponse' do
    it 'should create an instance of GetCategoryResponse' do
      expect(instance).to be_instance_of(Crossly::GetCategoryResponse)
    end
  end
