...
# Unit tests for Crossly::ErrorError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ErrorError do
  let(:instance) { Crossly::ErrorError.new }

  describe 'test an instance of ErrorError' do
    it 'should create an instance of ErrorError' do
      expect(instance).to be_instance_of(Crossly::ErrorError)
    end
  end
