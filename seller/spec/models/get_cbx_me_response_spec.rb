...
# Unit tests for Crossly::GetCbxMeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetCbxMeResponse do
  let(:instance) { Crossly::GetCbxMeResponse.new }

  describe 'test an instance of GetCbxMeResponse' do
    it 'should create an instance of GetCbxMeResponse' do
      expect(instance).to be_instance_of(Crossly::GetCbxMeResponse)
    end
  end
