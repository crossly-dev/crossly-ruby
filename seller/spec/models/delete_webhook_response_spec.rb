...
# Unit tests for Crossly::DeleteWebhookResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteWebhookResponse do
  let(:instance) { Crossly::DeleteWebhookResponse.new }

  describe 'test an instance of DeleteWebhookResponse' do
    it 'should create an instance of DeleteWebhookResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteWebhookResponse)
    end
  end
