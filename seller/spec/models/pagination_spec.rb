...
# Unit tests for Crossly::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::Pagination do
  let(:instance) { Crossly::Pagination.new }

  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      expect(instance).to be_instance_of(Crossly::Pagination)
    end
  end
