...
# Unit tests for Crossly::GetSpatialPublicResponseSolved
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetSpatialPublicResponseSolved do
  let(:instance) { Crossly::GetSpatialPublicResponseSolved.new }
  ...
  describe 'test an instance of GetSpatialPublicResponseSolved' do
    it 'should create an instance of GetSpatialPublicResponseSolved' do
      expect(instance).to be_instance_of(Crossly::GetSpatialPublicResponseSolved)
    end
  end
