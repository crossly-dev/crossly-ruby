...
# Unit tests for Crossly::GetMagicDraftResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetMagicDraftResponse do
  let(:instance) { Crossly::GetMagicDraftResponse.new }

  describe 'test an instance of GetMagicDraftResponse' do
    it 'should create an instance of GetMagicDraftResponse' do
      expect(instance).to be_instance_of(Crossly::GetMagicDraftResponse)
    end
  end
