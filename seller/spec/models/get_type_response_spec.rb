...
# Unit tests for Crossly::GetTypeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetTypeResponse do
  let(:instance) { Crossly::GetTypeResponse.new }

  describe 'test an instance of GetTypeResponse' do
    it 'should create an instance of GetTypeResponse' do
      expect(instance).to be_instance_of(Crossly::GetTypeResponse)
    end
  end
