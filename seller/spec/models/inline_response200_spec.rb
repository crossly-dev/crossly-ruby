...
# Unit tests for Crossly::InlineResponse200
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::InlineResponse200 do
  let(:instance) { Crossly::InlineResponse200.new }

  describe 'test an instance of InlineResponse200' do
    it 'should create an instance of InlineResponse200' do
      expect(instance).to be_instance_of(Crossly::InlineResponse200)
    end
  end
  ...
  describe 'test attribute "pat_prefix"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
