...
# Unit tests for Crossly::CreateInboxOfferResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateInboxOfferResponse do
  let(:instance) { Crossly::CreateInboxOfferResponse.new }

  describe 'test an instance of CreateInboxOfferResponse' do
    it 'should create an instance of CreateInboxOfferResponse' do
      expect(instance).to be_instance_of(Crossly::CreateInboxOfferResponse)
    end
  end
