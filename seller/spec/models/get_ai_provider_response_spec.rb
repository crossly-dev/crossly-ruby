...
# Unit tests for Crossly::GetAiProviderResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAiProviderResponse do
  let(:instance) { Crossly::GetAiProviderResponse.new }

  describe 'test an instance of GetAiProviderResponse' do
    it 'should create an instance of GetAiProviderResponse' do
      expect(instance).to be_instance_of(Crossly::GetAiProviderResponse)
    end
  end
