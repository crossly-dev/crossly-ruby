...
# Unit tests for Crossly::ListCompWatchlistRecentItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListCompWatchlistRecentItem do
  let(:instance) { Crossly::ListCompWatchlistRecentItem.new }
  ...
  describe 'test an instance of ListCompWatchlistRecentItem' do
    it 'should create an instance of ListCompWatchlistRecentItem' do
      expect(instance).to be_instance_of(Crossly::ListCompWatchlistRecentItem)
    end
  end
