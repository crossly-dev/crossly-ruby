...
# Unit tests for Crossly::GetOrderEvidenceResponseUnits
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetOrderEvidenceResponseUnits do
  let(:instance) { Crossly::GetOrderEvidenceResponseUnits.new }
  ...
  describe 'test an instance of GetOrderEvidenceResponseUnits' do
    it 'should create an instance of GetOrderEvidenceResponseUnits' do
      expect(instance).to be_instance_of(Crossly::GetOrderEvidenceResponseUnits)
    end
  end
