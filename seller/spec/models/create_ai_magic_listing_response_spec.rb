...
# Unit tests for Crossly::CreateAiMagicListingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateAiMagicListingResponse do
  let(:instance) { Crossly::CreateAiMagicListingResponse.new }
  ...
  describe 'test an instance of CreateAiMagicListingResponse' do
    it 'should create an instance of CreateAiMagicListingResponse' do
      expect(instance).to be_instance_of(Crossly::CreateAiMagicListingResponse)
    end
  end
