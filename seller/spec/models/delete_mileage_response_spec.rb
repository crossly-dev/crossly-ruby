...
# Unit tests for Crossly::DeleteMileageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteMileageResponse do
  let(:instance) { Crossly::DeleteMileageResponse.new }

  describe 'test an instance of DeleteMileageResponse' do
    it 'should create an instance of DeleteMileageResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteMileageResponse)
    end
  end
