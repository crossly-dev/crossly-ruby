...
# Unit tests for Crossly::CreateCbxSubjectResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateCbxSubjectResponse do
  let(:instance) { Crossly::CreateCbxSubjectResponse.new }

  describe 'test an instance of CreateCbxSubjectResponse' do
    it 'should create an instance of CreateCbxSubjectResponse' do
      expect(instance).to be_instance_of(Crossly::CreateCbxSubjectResponse)
    end
  end
