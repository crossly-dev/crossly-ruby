...
# Unit tests for Crossly::CreateOrderRefundResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateOrderRefundResponse do
  let(:instance) { Crossly::CreateOrderRefundResponse.new }

  describe 'test an instance of CreateOrderRefundResponse' do
    it 'should create an instance of CreateOrderRefundResponse' do
      expect(instance).to be_instance_of(Crossly::CreateOrderRefundResponse)
    end
  end
