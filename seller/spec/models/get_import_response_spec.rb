...
# Unit tests for Crossly::GetImportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetImportResponse do
  let(:instance) { Crossly::GetImportResponse.new }

  describe 'test an instance of GetImportResponse' do
    it 'should create an instance of GetImportResponse' do
      expect(instance).to be_instance_of(Crossly::GetImportResponse)
    end
  end
