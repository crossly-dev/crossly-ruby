...
# Unit tests for Crossly::GetConnectionHealthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetConnectionHealthResponse do
  let(:instance) { Crossly::GetConnectionHealthResponse.new }
  ...
  describe 'test an instance of GetConnectionHealthResponse' do
    it 'should create an instance of GetConnectionHealthResponse' do
      expect(instance).to be_instance_of(Crossly::GetConnectionHealthResponse)
    end
  end
