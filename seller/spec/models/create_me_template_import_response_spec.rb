...
# Unit tests for Crossly::CreateMeTemplateImportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateMeTemplateImportResponse do
  let(:instance) { Crossly::CreateMeTemplateImportResponse.new }
  ...
  describe 'test an instance of CreateMeTemplateImportResponse' do
    it 'should create an instance of CreateMeTemplateImportResponse' do
      expect(instance).to be_instance_of(Crossly::CreateMeTemplateImportResponse)
    end
  end
