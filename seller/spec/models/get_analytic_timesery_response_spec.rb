...
# Unit tests for Crossly::GetAnalyticTimeseryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAnalyticTimeseryResponse do
  let(:instance) { Crossly::GetAnalyticTimeseryResponse.new }
  ...
  describe 'test an instance of GetAnalyticTimeseryResponse' do
    it 'should create an instance of GetAnalyticTimeseryResponse' do
      expect(instance).to be_instance_of(Crossly::GetAnalyticTimeseryResponse)
    end
  end
