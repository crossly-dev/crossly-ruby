...
# Unit tests for Crossly::CreateAiTestKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateAiTestKeyResponse do
  let(:instance) { Crossly::CreateAiTestKeyResponse.new }

  describe 'test an instance of CreateAiTestKeyResponse' do
    it 'should create an instance of CreateAiTestKeyResponse' do
      expect(instance).to be_instance_of(Crossly::CreateAiTestKeyResponse)
    end
  end
