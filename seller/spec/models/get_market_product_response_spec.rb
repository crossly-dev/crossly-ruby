...
# Unit tests for Crossly::GetMarketProductResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetMarketProductResponse do
  let(:instance) { Crossly::GetMarketProductResponse.new }

  describe 'test an instance of GetMarketProductResponse' do
    it 'should create an instance of GetMarketProductResponse' do
      expect(instance).to be_instance_of(Crossly::GetMarketProductResponse)
    end
  end
