...
# Unit tests for Crossly::CreateBuyerCheckoutResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateBuyerCheckoutResponse do
  let(:instance) { Crossly::CreateBuyerCheckoutResponse.new }
  ...
  describe 'test an instance of CreateBuyerCheckoutResponse' do
    it 'should create an instance of CreateBuyerCheckoutResponse' do
      expect(instance).to be_instance_of(Crossly::CreateBuyerCheckoutResponse)
    end
  end
