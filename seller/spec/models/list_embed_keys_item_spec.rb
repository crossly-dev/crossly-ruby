...
# Unit tests for Crossly::ListEmbedKeysItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListEmbedKeysItem do
  let(:instance) { Crossly::ListEmbedKeysItem.new }

  describe 'test an instance of ListEmbedKeysItem' do
    it 'should create an instance of ListEmbedKeysItem' do
      expect(instance).to be_instance_of(Crossly::ListEmbedKeysItem)
    end
  end
