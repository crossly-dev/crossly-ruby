...
# Unit tests for Crossly::ListTaxonomySuggestItemDisplays
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListTaxonomySuggestItemDisplays do
  let(:instance) { Crossly::ListTaxonomySuggestItemDisplays.new }
  ...
  describe 'test an instance of ListTaxonomySuggestItemDisplays' do
    it 'should create an instance of ListTaxonomySuggestItemDisplays' do
      expect(instance).to be_instance_of(Crossly::ListTaxonomySuggestItemDisplays)
    end
  end
