...
# Unit tests for Crossly::ListWorkflowChainsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListWorkflowChainsItem do
  let(:instance) { Crossly::ListWorkflowChainsItem.new }

  describe 'test an instance of ListWorkflowChainsItem' do
    it 'should create an instance of ListWorkflowChainsItem' do
      expect(instance).to be_instance_of(Crossly::ListWorkflowChainsItem)
    end
  end
