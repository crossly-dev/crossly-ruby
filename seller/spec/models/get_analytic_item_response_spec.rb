...
# Unit tests for Crossly::GetAnalyticItemResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAnalyticItemResponse do
  let(:instance) { Crossly::GetAnalyticItemResponse.new }

  describe 'test an instance of GetAnalyticItemResponse' do
    it 'should create an instance of GetAnalyticItemResponse' do
      expect(instance).to be_instance_of(Crossly::GetAnalyticItemResponse)
    end
  end
