...
# Unit tests for Crossly::GetOrderEvidenceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetOrderEvidenceResponse do
  let(:instance) { Crossly::GetOrderEvidenceResponse.new }

  describe 'test an instance of GetOrderEvidenceResponse' do
    it 'should create an instance of GetOrderEvidenceResponse' do
      expect(instance).to be_instance_of(Crossly::GetOrderEvidenceResponse)
    end
  end
