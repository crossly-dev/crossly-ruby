...
# Unit tests for Crossly::CreateNetworkPoolResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateNetworkPoolResponse do
  let(:instance) { Crossly::CreateNetworkPoolResponse.new }

  describe 'test an instance of CreateNetworkPoolResponse' do
    it 'should create an instance of CreateNetworkPoolResponse' do
      expect(instance).to be_instance_of(Crossly::CreateNetworkPoolResponse)
    end
  end
