...
# Unit tests for Crossly::GetNetworkPoolResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetNetworkPoolResponse do
  let(:instance) { Crossly::GetNetworkPoolResponse.new }

  describe 'test an instance of GetNetworkPoolResponse' do
    it 'should create an instance of GetNetworkPoolResponse' do
      expect(instance).to be_instance_of(Crossly::GetNetworkPoolResponse)
    end
  end
