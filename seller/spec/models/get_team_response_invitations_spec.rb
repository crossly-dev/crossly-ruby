...
# Unit tests for Crossly::GetTeamResponseInvitations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetTeamResponseInvitations do
  let(:instance) { Crossly::GetTeamResponseInvitations.new }

  describe 'test an instance of GetTeamResponseInvitations' do
    it 'should create an instance of GetTeamResponseInvitations' do
      expect(instance).to be_instance_of(Crossly::GetTeamResponseInvitations)
    end
  end
