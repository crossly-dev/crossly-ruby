...
# Unit tests for Crossly::InlineObject3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::InlineObject3 do
  let(:instance) { Crossly::InlineObject3.new }

  describe 'test an instance of InlineObject3' do
    it 'should create an instance of InlineObject3' do
      expect(instance).to be_instance_of(Crossly::InlineObject3)
    end
  end
