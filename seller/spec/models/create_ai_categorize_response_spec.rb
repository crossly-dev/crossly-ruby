...
# Unit tests for Crossly::CreateAiCategorizeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateAiCategorizeResponse do
  let(:instance) { Crossly::CreateAiCategorizeResponse.new }

  describe 'test an instance of CreateAiCategorizeResponse' do
    it 'should create an instance of CreateAiCategorizeResponse' do
      expect(instance).to be_instance_of(Crossly::CreateAiCategorizeResponse)
    end
  end
