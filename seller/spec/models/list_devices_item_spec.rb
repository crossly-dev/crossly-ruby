...
# Unit tests for Crossly::ListDevicesItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListDevicesItem do
  let(:instance) { Crossly::ListDevicesItem.new }

  describe 'test an instance of ListDevicesItem' do
    it 'should create an instance of ListDevicesItem' do
      expect(instance).to be_instance_of(Crossly::ListDevicesItem)
    end
  end
