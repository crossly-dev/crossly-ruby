...
# Unit tests for Crossly::CreateOrderRateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateOrderRateResponse do
  let(:instance) { Crossly::CreateOrderRateResponse.new }

  describe 'test an instance of CreateOrderRateResponse' do
    it 'should create an instance of CreateOrderRateResponse' do
      expect(instance).to be_instance_of(Crossly::CreateOrderRateResponse)
    end
  end
