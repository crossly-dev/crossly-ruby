...
# Unit tests for Crossly::CreateAutomationRuleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateAutomationRuleResponse do
  let(:instance) { Crossly::CreateAutomationRuleResponse.new }
  ...
  describe 'test an instance of CreateAutomationRuleResponse' do
    it 'should create an instance of CreateAutomationRuleResponse' do
      expect(instance).to be_instance_of(Crossly::CreateAutomationRuleResponse)
    end
  end
