...
# Unit tests for Crossly::GetAnalyticTimeseryResponseSeries
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAnalyticTimeseryResponseSeries do
  let(:instance) { Crossly::GetAnalyticTimeseryResponseSeries.new }
  ...
  describe 'test an instance of GetAnalyticTimeseryResponseSeries' do
    it 'should create an instance of GetAnalyticTimeseryResponseSeries' do
      expect(instance).to be_instance_of(Crossly::GetAnalyticTimeseryResponseSeries)
    end
  end
