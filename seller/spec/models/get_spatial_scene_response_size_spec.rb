...
# Unit tests for Crossly::GetSpatialSceneResponseSize
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetSpatialSceneResponseSize do
  let(:instance) { Crossly::GetSpatialSceneResponseSize.new }
  ...
  describe 'test an instance of GetSpatialSceneResponseSize' do
    it 'should create an instance of GetSpatialSceneResponseSize' do
      expect(instance).to be_instance_of(Crossly::GetSpatialSceneResponseSize)
    end
  end
