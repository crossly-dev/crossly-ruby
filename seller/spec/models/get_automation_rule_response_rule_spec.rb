...
# Unit tests for Crossly::GetAutomationRuleResponseRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAutomationRuleResponseRule do
  let(:instance) { Crossly::GetAutomationRuleResponseRule.new }
  ...
  describe 'test an instance of GetAutomationRuleResponseRule' do
    it 'should create an instance of GetAutomationRuleResponseRule' do
      expect(instance).to be_instance_of(Crossly::GetAutomationRuleResponseRule)
    end
  end
