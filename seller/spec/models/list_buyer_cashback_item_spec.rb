...
# Unit tests for Crossly::ListBuyerCashbackItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListBuyerCashbackItem do
  let(:instance) { Crossly::ListBuyerCashbackItem.new }

  describe 'test an instance of ListBuyerCashbackItem' do
    it 'should create an instance of ListBuyerCashbackItem' do
      expect(instance).to be_instance_of(Crossly::ListBuyerCashbackItem)
    end
  end
