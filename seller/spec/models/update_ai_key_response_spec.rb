...
# Unit tests for Crossly::UpdateAiKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::UpdateAiKeyResponse do
  let(:instance) { Crossly::UpdateAiKeyResponse.new }

  describe 'test an instance of UpdateAiKeyResponse' do
    it 'should create an instance of UpdateAiKeyResponse' do
      expect(instance).to be_instance_of(Crossly::UpdateAiKeyResponse)
    end
  end
