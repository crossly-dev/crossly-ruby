...
# Unit tests for Crossly::UpdateMeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::UpdateMeResponse do
  let(:instance) { Crossly::UpdateMeResponse.new }

  describe 'test an instance of UpdateMeResponse' do
    it 'should create an instance of UpdateMeResponse' do
      expect(instance).to be_instance_of(Crossly::UpdateMeResponse)
    end
  end
