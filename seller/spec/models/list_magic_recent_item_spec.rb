...
# Unit tests for Crossly::ListMagicRecentItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListMagicRecentItem do
  let(:instance) { Crossly::ListMagicRecentItem.new }

  describe 'test an instance of ListMagicRecentItem' do
    it 'should create an instance of ListMagicRecentItem' do
      expect(instance).to be_instance_of(Crossly::ListMagicRecentItem)
    end
  end
