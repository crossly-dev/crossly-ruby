...
# Unit tests for Crossly::CreateBillingUpgradeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateBillingUpgradeResponse do
  let(:instance) { Crossly::CreateBillingUpgradeResponse.new }
  ...
  describe 'test an instance of CreateBillingUpgradeResponse' do
    it 'should create an instance of CreateBillingUpgradeResponse' do
      expect(instance).to be_instance_of(Crossly::CreateBillingUpgradeResponse)
    end
  end
