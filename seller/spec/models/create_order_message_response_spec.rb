...
# Unit tests for Crossly::CreateOrderMessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateOrderMessageResponse do
  let(:instance) { Crossly::CreateOrderMessageResponse.new }

  describe 'test an instance of CreateOrderMessageResponse' do
    it 'should create an instance of CreateOrderMessageResponse' do
      expect(instance).to be_instance_of(Crossly::CreateOrderMessageResponse)
    end
  end
