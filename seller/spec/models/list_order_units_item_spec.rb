...
# Unit tests for Crossly::ListOrderUnitsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListOrderUnitsItem do
  let(:instance) { Crossly::ListOrderUnitsItem.new }

  describe 'test an instance of ListOrderUnitsItem' do
    it 'should create an instance of ListOrderUnitsItem' do
      expect(instance).to be_instance_of(Crossly::ListOrderUnitsItem)
    end
  end
