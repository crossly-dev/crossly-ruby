...
# Unit tests for Crossly::UpdatePolicyPresetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::UpdatePolicyPresetResponse do
  let(:instance) { Crossly::UpdatePolicyPresetResponse.new }

  describe 'test an instance of UpdatePolicyPresetResponse' do
    it 'should create an instance of UpdatePolicyPresetResponse' do
      expect(instance).to be_instance_of(Crossly::UpdatePolicyPresetResponse)
    end
  end
