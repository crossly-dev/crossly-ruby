...
# Unit tests for Crossly::GetOauthInitResponseOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetOauthInitResponseOneOf1 do
  let(:instance) { Crossly::GetOauthInitResponseOneOf1.new }

  describe 'test an instance of GetOauthInitResponseOneOf1' do
    it 'should create an instance of GetOauthInitResponseOneOf1' do
      expect(instance).to be_instance_of(Crossly::GetOauthInitResponseOneOf1)
    end
  end
