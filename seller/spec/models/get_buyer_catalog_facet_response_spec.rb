...
# Unit tests for Crossly::GetBuyerCatalogFacetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetBuyerCatalogFacetResponse do
  let(:instance) { Crossly::GetBuyerCatalogFacetResponse.new }
  ...
  describe 'test an instance of GetBuyerCatalogFacetResponse' do
    it 'should create an instance of GetBuyerCatalogFacetResponse' do
      expect(instance).to be_instance_of(Crossly::GetBuyerCatalogFacetResponse)
    end
  end
