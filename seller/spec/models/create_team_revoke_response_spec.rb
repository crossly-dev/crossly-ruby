...
# Unit tests for Crossly::CreateTeamRevokeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateTeamRevokeResponse do
  let(:instance) { Crossly::CreateTeamRevokeResponse.new }

  describe 'test an instance of CreateTeamRevokeResponse' do
    it 'should create an instance of CreateTeamRevokeResponse' do
      expect(instance).to be_instance_of(Crossly::CreateTeamRevokeResponse)
    end
  end
