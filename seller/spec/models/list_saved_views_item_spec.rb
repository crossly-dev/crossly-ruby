...
# Unit tests for Crossly::ListSavedViewsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListSavedViewsItem do
  let(:instance) { Crossly::ListSavedViewsItem.new }

  describe 'test an instance of ListSavedViewsItem' do
    it 'should create an instance of ListSavedViewsItem' do
      expect(instance).to be_instance_of(Crossly::ListSavedViewsItem)
    end
  end
