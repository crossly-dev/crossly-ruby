...
# Unit tests for Crossly::ListMileageItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::ListMileageItem do
  let(:instance) { Crossly::ListMileageItem.new }

  describe 'test an instance of ListMileageItem' do
    it 'should create an instance of ListMileageItem' do
      expect(instance).to be_instance_of(Crossly::ListMileageItem)
    end
  end
