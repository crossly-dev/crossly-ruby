...
# Unit tests for Crossly::GetActionLogResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetActionLogResponse do
  let(:instance) { Crossly::GetActionLogResponse.new }

  describe 'test an instance of GetActionLogResponse' do
    it 'should create an instance of GetActionLogResponse' do
      expect(instance).to be_instance_of(Crossly::GetActionLogResponse)
    end
  end
