...
# Unit tests for Crossly::CreatePatResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreatePatResponse do
  let(:instance) { Crossly::CreatePatResponse.new }

  describe 'test an instance of CreatePatResponse' do
    it 'should create an instance of CreatePatResponse' do
      expect(instance).to be_instance_of(Crossly::CreatePatResponse)
    end
  end
