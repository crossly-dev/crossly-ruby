...
# Unit tests for Crossly::CreateEmbedKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateEmbedKeyResponse do
  let(:instance) { Crossly::CreateEmbedKeyResponse.new }

  describe 'test an instance of CreateEmbedKeyResponse' do
    it 'should create an instance of CreateEmbedKeyResponse' do
      expect(instance).to be_instance_of(Crossly::CreateEmbedKeyResponse)
    end
  end
