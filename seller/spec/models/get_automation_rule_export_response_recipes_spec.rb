...
# Unit tests for Crossly::GetAutomationRuleExportResponseRecipes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetAutomationRuleExportResponseRecipes do
  let(:instance) { Crossly::GetAutomationRuleExportResponseRecipes.new }
  ...
  describe 'test an instance of GetAutomationRuleExportResponseRecipes' do
    it 'should create an instance of GetAutomationRuleExportResponseRecipes' do
      expect(instance).to be_instance_of(Crossly::GetAutomationRuleExportResponseRecipes)
    end
  end
