...
# Unit tests for Crossly::GetWorkflowChainResponseChain
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::GetWorkflowChainResponseChain do
  let(:instance) { Crossly::GetWorkflowChainResponseChain.new }
  ...
  describe 'test an instance of GetWorkflowChainResponseChain' do
    it 'should create an instance of GetWorkflowChainResponseChain' do
      expect(instance).to be_instance_of(Crossly::GetWorkflowChainResponseChain)
    end
  end
