...
# Unit tests for Crossly::DeleteMobilePushTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::DeleteMobilePushTokenResponse do
  let(:instance) { Crossly::DeleteMobilePushTokenResponse.new }
  ...
  describe 'test an instance of DeleteMobilePushTokenResponse' do
    it 'should create an instance of DeleteMobilePushTokenResponse' do
      expect(instance).to be_instance_of(Crossly::DeleteMobilePushTokenResponse)
    end
  end
