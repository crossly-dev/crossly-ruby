...
# Unit tests for Crossly::CreateSavedViewResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crossly::CreateSavedViewResponse do
  let(:instance) { Crossly::CreateSavedViewResponse.new }

  describe 'test an instance of CreateSavedViewResponse' do
    it 'should create an instance of CreateSavedViewResponse' do
      expect(instance).to be_instance_of(Crossly::CreateSavedViewResponse)
    end
  end
