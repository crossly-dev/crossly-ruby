...
# Unit tests for CrosslyBuyer::CreateAiMagicListingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateAiMagicListingResponse do
  let(:instance) { CrosslyBuyer::CreateAiMagicListingResponse.new }

  describe 'test an instance of CreateAiMagicListingResponse' do
    it 'should create an instance of CreateAiMagicListingResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateAiMagicListingResponse)
    end
  end
