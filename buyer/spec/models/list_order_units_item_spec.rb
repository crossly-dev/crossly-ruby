...
# Unit tests for CrosslyBuyer::ListOrderUnitsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListOrderUnitsItem do
  let(:instance) { CrosslyBuyer::ListOrderUnitsItem.new }

  describe 'test an instance of ListOrderUnitsItem' do
    it 'should create an instance of ListOrderUnitsItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListOrderUnitsItem)
    end
  end
