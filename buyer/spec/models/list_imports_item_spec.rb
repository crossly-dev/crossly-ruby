...
# Unit tests for CrosslyBuyer::ListImportsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListImportsItem do
  let(:instance) { CrosslyBuyer::ListImportsItem.new }

  describe 'test an instance of ListImportsItem' do
    it 'should create an instance of ListImportsItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListImportsItem)
    end
  end
