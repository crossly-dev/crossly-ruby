...
# Unit tests for CrosslyBuyer::UpdateMeTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::UpdateMeTemplateResponse do
  let(:instance) { CrosslyBuyer::UpdateMeTemplateResponse.new }

  describe 'test an instance of UpdateMeTemplateResponse' do
    it 'should create an instance of UpdateMeTemplateResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::UpdateMeTemplateResponse)
    end
  end
