...
# Unit tests for CrosslyBuyer::CreateAutomationRuleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateAutomationRuleResponse do
  let(:instance) { CrosslyBuyer::CreateAutomationRuleResponse.new }

  describe 'test an instance of CreateAutomationRuleResponse' do
    it 'should create an instance of CreateAutomationRuleResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateAutomationRuleResponse)
    end
  end
