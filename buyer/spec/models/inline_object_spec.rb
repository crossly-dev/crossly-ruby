...
# Unit tests for CrosslyBuyer::InlineObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::InlineObject do
  let(:instance) { CrosslyBuyer::InlineObject.new }

  describe 'test an instance of InlineObject' do
    it 'should create an instance of InlineObject' do
      expect(instance).to be_instance_of(CrosslyBuyer::InlineObject)
    end
  end
