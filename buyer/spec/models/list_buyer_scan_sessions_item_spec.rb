...
# Unit tests for CrosslyBuyer::ListBuyerScanSessionsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListBuyerScanSessionsItem do
  let(:instance) { CrosslyBuyer::ListBuyerScanSessionsItem.new }

  describe 'test an instance of ListBuyerScanSessionsItem' do
    it 'should create an instance of ListBuyerScanSessionsItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListBuyerScanSessionsItem)
    end
  end
