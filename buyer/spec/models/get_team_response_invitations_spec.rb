...
# Unit tests for CrosslyBuyer::GetTeamResponseInvitations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetTeamResponseInvitations do
  let(:instance) { CrosslyBuyer::GetTeamResponseInvitations.new }

  describe 'test an instance of GetTeamResponseInvitations' do
    it 'should create an instance of GetTeamResponseInvitations' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetTeamResponseInvitations)
    end
  end
