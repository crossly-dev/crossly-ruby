...
# Unit tests for CrosslyBuyer::ListAutomationRunsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListAutomationRunsItem do
  let(:instance) { CrosslyBuyer::ListAutomationRunsItem.new }

  describe 'test an instance of ListAutomationRunsItem' do
    it 'should create an instance of ListAutomationRunsItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListAutomationRunsItem)
    end
  end
