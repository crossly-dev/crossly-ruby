...
# Unit tests for CrosslyBuyer::CreateOrderMessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateOrderMessageResponse do
  let(:instance) { CrosslyBuyer::CreateOrderMessageResponse.new }

  describe 'test an instance of CreateOrderMessageResponse' do
    it 'should create an instance of CreateOrderMessageResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateOrderMessageResponse)
    end
  end
