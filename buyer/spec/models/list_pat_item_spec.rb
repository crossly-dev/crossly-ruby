...
# Unit tests for CrosslyBuyer::ListPatItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListPatItem do
  let(:instance) { CrosslyBuyer::ListPatItem.new }

  describe 'test an instance of ListPatItem' do
    it 'should create an instance of ListPatItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListPatItem)
    end
  end
