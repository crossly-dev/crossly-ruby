...
# Unit tests for CrosslyBuyer::ListAutomationRulesItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListAutomationRulesItem do
  let(:instance) { CrosslyBuyer::ListAutomationRulesItem.new }

  describe 'test an instance of ListAutomationRulesItem' do
    it 'should create an instance of ListAutomationRulesItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListAutomationRulesItem)
    end
  end
