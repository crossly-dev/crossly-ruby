...
# Unit tests for CrosslyBuyer::InlineObject1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::InlineObject1 do
  let(:instance) { CrosslyBuyer::InlineObject1.new }

  describe 'test an instance of InlineObject1' do
    it 'should create an instance of InlineObject1' do
      expect(instance).to be_instance_of(CrosslyBuyer::InlineObject1)
    end
  end
