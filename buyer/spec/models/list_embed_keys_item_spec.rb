...
# Unit tests for CrosslyBuyer::ListEmbedKeysItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListEmbedKeysItem do
  let(:instance) { CrosslyBuyer::ListEmbedKeysItem.new }

  describe 'test an instance of ListEmbedKeysItem' do
    it 'should create an instance of ListEmbedKeysItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListEmbedKeysItem)
    end
  end
