...
# Unit tests for CrosslyBuyer::CreateBuyerCheckoutResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateBuyerCheckoutResponse do
  let(:instance) { CrosslyBuyer::CreateBuyerCheckoutResponse.new }

  describe 'test an instance of CreateBuyerCheckoutResponse' do
    it 'should create an instance of CreateBuyerCheckoutResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateBuyerCheckoutResponse)
    end
  end
