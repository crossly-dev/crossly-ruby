...
# Unit tests for CrosslyBuyer::ListPolicyPresetsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListPolicyPresetsItem do
  let(:instance) { CrosslyBuyer::ListPolicyPresetsItem.new }

  describe 'test an instance of ListPolicyPresetsItem' do
    it 'should create an instance of ListPolicyPresetsItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListPolicyPresetsItem)
    end
  end
