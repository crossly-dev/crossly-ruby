...
# Unit tests for CrosslyBuyer::GetCategoryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetCategoryResponse do
  let(:instance) { CrosslyBuyer::GetCategoryResponse.new }

  describe 'test an instance of GetCategoryResponse' do
    it 'should create an instance of GetCategoryResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetCategoryResponse)
    end
  end
