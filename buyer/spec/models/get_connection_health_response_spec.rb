...
# Unit tests for CrosslyBuyer::GetConnectionHealthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetConnectionHealthResponse do
  let(:instance) { CrosslyBuyer::GetConnectionHealthResponse.new }

  describe 'test an instance of GetConnectionHealthResponse' do
    it 'should create an instance of GetConnectionHealthResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetConnectionHealthResponse)
    end
  end
