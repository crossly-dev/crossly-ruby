...
# Unit tests for CrosslyBuyer::GetTypeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetTypeResponse do
  let(:instance) { CrosslyBuyer::GetTypeResponse.new }

  describe 'test an instance of GetTypeResponse' do
    it 'should create an instance of GetTypeResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetTypeResponse)
    end
  end
