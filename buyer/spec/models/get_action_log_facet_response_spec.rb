...
# Unit tests for CrosslyBuyer::GetActionLogFacetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetActionLogFacetResponse do
  let(:instance) { CrosslyBuyer::GetActionLogFacetResponse.new }

  describe 'test an instance of GetActionLogFacetResponse' do
    it 'should create an instance of GetActionLogFacetResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetActionLogFacetResponse)
    end
  end
