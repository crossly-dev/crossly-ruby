...
# Unit tests for CrosslyBuyer::GetActionLogResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetActionLogResponse do
  let(:instance) { CrosslyBuyer::GetActionLogResponse.new }

  describe 'test an instance of GetActionLogResponse' do
    it 'should create an instance of GetActionLogResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetActionLogResponse)
    end
  end
