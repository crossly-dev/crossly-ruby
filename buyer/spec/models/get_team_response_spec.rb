...
# Unit tests for CrosslyBuyer::GetTeamResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetTeamResponse do
  let(:instance) { CrosslyBuyer::GetTeamResponse.new }

  describe 'test an instance of GetTeamResponse' do
    it 'should create an instance of GetTeamResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetTeamResponse)
    end
  end
