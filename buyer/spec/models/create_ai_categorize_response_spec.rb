...
# Unit tests for CrosslyBuyer::CreateAiCategorizeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateAiCategorizeResponse do
  let(:instance) { CrosslyBuyer::CreateAiCategorizeResponse.new }

  describe 'test an instance of CreateAiCategorizeResponse' do
    it 'should create an instance of CreateAiCategorizeResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateAiCategorizeResponse)
    end
  end
