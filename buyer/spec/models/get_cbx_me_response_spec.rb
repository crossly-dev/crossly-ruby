...
# Unit tests for CrosslyBuyer::GetCbxMeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetCbxMeResponse do
  let(:instance) { CrosslyBuyer::GetCbxMeResponse.new }

  describe 'test an instance of GetCbxMeResponse' do
    it 'should create an instance of GetCbxMeResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetCbxMeResponse)
    end
  end
  ...
  describe 'test attribute "scopes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["campaign", "read", "accrue", "spend", "treasury"])
