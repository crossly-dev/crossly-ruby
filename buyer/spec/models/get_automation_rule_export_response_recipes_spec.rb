...
# Unit tests for CrosslyBuyer::GetAutomationRuleExportResponseRecipes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetAutomationRuleExportResponseRecipes do
  let(:instance) { CrosslyBuyer::GetAutomationRuleExportResponseRecipes.new }

  describe 'test an instance of GetAutomationRuleExportResponseRecipes' do
    it 'should create an instance of GetAutomationRuleExportResponseRecipes' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetAutomationRuleExportResponseRecipes)
    end
  end
