...
# Unit tests for CrosslyBuyer::InlineObject3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::InlineObject3 do
  let(:instance) { CrosslyBuyer::InlineObject3.new }

  describe 'test an instance of InlineObject3' do
    it 'should create an instance of InlineObject3' do
      expect(instance).to be_instance_of(CrosslyBuyer::InlineObject3)
    end
  end
