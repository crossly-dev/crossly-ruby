...
# Unit tests for CrosslyBuyer::CreateMeTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateMeTemplateResponse do
  let(:instance) { CrosslyBuyer::CreateMeTemplateResponse.new }

  describe 'test an instance of CreateMeTemplateResponse' do
    it 'should create an instance of CreateMeTemplateResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateMeTemplateResponse)
    end
  end
