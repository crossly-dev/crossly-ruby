...
# Unit tests for CrosslyBuyer::GetGenderResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetGenderResponse do
  let(:instance) { CrosslyBuyer::GetGenderResponse.new }

  describe 'test an instance of GetGenderResponse' do
    it 'should create an instance of GetGenderResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetGenderResponse)
    end
  end
