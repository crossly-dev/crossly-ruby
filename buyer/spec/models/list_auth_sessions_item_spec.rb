...
# Unit tests for CrosslyBuyer::ListAuthSessionsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::ListAuthSessionsItem do
  let(:instance) { CrosslyBuyer::ListAuthSessionsItem.new }

  describe 'test an instance of ListAuthSessionsItem' do
    it 'should create an instance of ListAuthSessionsItem' do
      expect(instance).to be_instance_of(CrosslyBuyer::ListAuthSessionsItem)
    end
  end
