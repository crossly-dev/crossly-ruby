...
# Unit tests for CrosslyBuyer::CreateAiGenerateListingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::CreateAiGenerateListingResponse do
  let(:instance) { CrosslyBuyer::CreateAiGenerateListingResponse.new }

  describe 'test an instance of CreateAiGenerateListingResponse' do
    it 'should create an instance of CreateAiGenerateListingResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::CreateAiGenerateListingResponse)
    end
  end
  ...
  describe 'test attribute "suggested_price"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
