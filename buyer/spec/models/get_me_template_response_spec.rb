...
# Unit tests for CrosslyBuyer::GetMeTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CrosslyBuyer::GetMeTemplateResponse do
  let(:instance) { CrosslyBuyer::GetMeTemplateResponse.new }

  describe 'test an instance of GetMeTemplateResponse' do
    it 'should create an instance of GetMeTemplateResponse' do
      expect(instance).to be_instance_of(CrosslyBuyer::GetMeTemplateResponse)
    end
  end
