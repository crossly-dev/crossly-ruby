  ...
  class GetOrderEvidenceResponseArrival
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::GetOrderEvidenceResponseArrival` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::GetOrderEvidenceResponseArrival`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["not_requested", "awaiting", "submitted", "declined", "window_closed"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["not_requested", "awaiting", "submitted", "declined", "window_closed"])
    ...
    def hash
      [state, window_hours, requested_at, closes_at, detail, photos].hash
    end
