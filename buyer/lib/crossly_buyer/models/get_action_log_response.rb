...
module CrosslyBuyer
  class GetActionLogResponse
    ...
    attr_accessor :actor_display_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::GetActionLogResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::GetActionLogResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'oauth_app_id')
        self.oauth_app_id = attributes[:'oauth_app_id']
      end
      ...
      if attributes.key?(:'actor_display_name')
        self.actor_display_name = attributes[:'actor_display_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          actor_display_name == o.actor_display_name
    end
    ...
    def hash
      [id, created_at, user_id, status, source, platform, action, latency_ms, error_class, error_message, ip_address, user_agent, oauth_app_id, category, actor_user_id, finished_at, correlation_id, track, target_type, target_id, http_status, actor_email, actor_display_name].hash
    end
