  ...
  class CreateListingBulkDelistPreviewResponseMarketplaces
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::CreateListingBulkDelistPreviewResponseMarketplaces` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::CreateListingBulkDelistPreviewResponseMarketplaces`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      account_status_validator = EnumAttributeValidator.new('String', ["active", "unknown", "needs_reauth"])
    ...
    def account_status=(account_status)
      validator = EnumAttributeValidator.new('String', ["active", "unknown", "needs_reauth"])
    ...
    def hash
      [platform, active_count, account_status].hash
    end
