  ...
  class ListTaxonomySuggestItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::ListTaxonomySuggestItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::ListTaxonomySuggestItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'breadcrumb')
        self.breadcrumb = attributes[:'breadcrumb']
      end

      if attributes.key?(:'displays')
        self.displays = attributes[:'displays']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @breadcrumb.nil?
        invalid_properties.push('invalid value for "breadcrumb", breadcrumb cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @breadcrumb.nil?
    ...
    def hash
      [external_id, display, level, catalog, breadcrumb, displays].hash
    end
