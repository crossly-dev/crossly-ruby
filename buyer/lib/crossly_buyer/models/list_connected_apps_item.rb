  ...
  class ListConnectedAppsItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::ListConnectedAppsItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::ListConnectedAppsItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'grant_id')
        self.grant_id = attributes[:'grant_id']
      end
    ...
    def list_invalid_properties
      ...
      if @grant_id.nil?
        invalid_properties.push('invalid value for "grant_id", grant_id cannot be nil.')
      end
      ...
      if @connected_at.nil?
        invalid_properties.push('invalid value for "connected_at", connected_at cannot be nil.')
      end
    ...
    def hash
      [grant_id, scopes, connected_at, last_used_at, app_id, app_name, app_description, homepage_url, developer_name, developer_email].hash
    end
