...
module CrosslyBuyer
  class CreateListingCheckDuplicateResponseMatches
    ...
    attr_accessor :variation_group_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::CreateListingCheckDuplicateResponseMatches` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::CreateListingCheckDuplicateResponseMatches`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'suggested')
        self.suggested = attributes[:'suggested']
      end

      if attributes.key?(:'variation_group_id')
        self.variation_group_id = attributes[:'variation_group_id']
      end
    ...
    def list_invalid_properties
      ...
      if @suggested.nil?
        invalid_properties.push('invalid value for "suggested", suggested cannot be nil.')
      end
    ...
    def valid?
      return false if @suggested.nil?
      suggested_validator = EnumAttributeValidator.new('String', ["variation", "restock", "duplicate"])
      return false unless suggested_validator.valid?(@suggested)
      return false if @title.nil?
      return false if @match_type.nil?
      match_type_validator = EnumAttributeValidator.new('String', ["title", "image"])
    ...
    # @param [Object] suggested Object to be assigned
    def suggested=(suggested)
      validator = EnumAttributeValidator.new('String', ["variation", "restock", "duplicate"])
      unless validator.valid?(suggested)
        fail ArgumentError, "invalid value for \"suggested\", must be one of #{validator.allowable_values}."
      end
      @suggested = suggested
    end
    ...
    def match_type=(match_type)
      validator = EnumAttributeValidator.new('String', ["title", "image"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          variation_group_id == o.variation_group_id &&
    ...
    def hash
      [suggested, variation_group_id, listing_id, inventory_item_id, title, image_url, match_type, score].hash
    end
