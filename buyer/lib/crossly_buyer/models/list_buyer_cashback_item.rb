  ...
  class ListBuyerCashbackItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::ListBuyerCashbackItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::ListBuyerCashbackItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'store_host')
        self.store_host = attributes[:'store_host']
      end

      if attributes.key?(:'order_cents')
        self.order_cents = attributes[:'order_cents']
      end

      if attributes.key?(:'cashback_cents')
        self.cashback_cents = attributes[:'cashback_cents']
      end
    ...
    def list_invalid_properties
      ...
      if @store_host.nil?
        invalid_properties.push('invalid value for "store_host", store_host cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @store_host.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          store_host == o.store_host &&
          order_cents == o.order_cents &&
          cashback_cents == o.cashback_cents &&
    ...
    def hash
      [id, status, store_name, store_host, order_cents, cashback_cents, activated_at, confirmed_at, paid_at, expired_at, rejected_reason].hash
    end
