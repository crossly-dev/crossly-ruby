  ...
  class CreateListingMagicFillResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CrosslyBuyer::CreateListingMagicFillResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CrosslyBuyer::CreateListingMagicFillResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ai_available')
        self.ai_available = attributes[:'ai_available']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ai_available.nil?
        invalid_properties.push('invalid value for "ai_available", ai_available cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ai_available.nil?
      true
    end
    ...
    def hash
      [filled, count, ai_available].hash
    end
